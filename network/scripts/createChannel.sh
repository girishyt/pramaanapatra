...
createAncorPeerTx() {
	...
	for orgmsp in PucMSP EngMSP TrainingMSP CompanyMSP; do
...
echo "Join PUC peers to the channel..."
joinChannel 1
echo "Join ENG peers to the channel..."
joinChannel 2
echo "Join Training peers to the channel..."
joinChannel 3
echo "Join Company peers to the channel..."
joinChannel 4

## Set the anchor peers for each org in the channel
echo "Updating anchor peers for PUC..."
updateAnchorPeers 1
echo "Updating anchor peers for ENG..."
updateAnchorPeers 2
echo "Updating anchor peers for Training..."
updateAnchorPeers 3
